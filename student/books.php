...
<body style="background-color: #3c763d4a; height: 900px;">
...
<div id="mySidenav" class="sidenav">
 ...
 <div style="margin-left:60px; ">
  ...
  <a href="requested_books.php">Requested Book</a>
 ...
 <!-- ________-------search bar------__________-->
   ...
   <div class="searchbar">
      <form class="navbar-form" method="post" name="form1">
           ...
           <input style="width: 300px; height: 40px; font-size: 20px;" type="text" name="search" placeholder="Search for available boobs.." required="">
...
<!--___________REQUEST BOOK________-->
       
       <form  class="navbar-form" method="post" name="form1">
        
           <input style="width: 300px; height: 40px; font-size: 20px;" type="text" name="bid" placeholder="Enter Book ID" required="">
           <button style="background-color: #6db6b9e6; height: 40px; width: 120px;" type="submit" name="submit1" class="btn btn-default">
             Request a book
           </button>
...
<div style="padding-left: 200px; width: 1300px;">  
   <?php
    ...
    if(isset($_POST['submit1']))
    {
      if(isset($_SESSION['login_user']))
      {
          $qr="SELECT * from books where bid='$_POST[bid]'";
