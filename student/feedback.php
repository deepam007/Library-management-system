  ...
  <div class="y" style=" color: red; margin-top: -600px;">
  	 ...
  	 <div class="bg" >
  	 	<h1 style="text-align: center; padding-top: 20px; font-size: 50px; color: navy;">Feel Free To Share Your THOUGHTS...</h1>
  	 	 <div class="box">
  	 	 	...
  	 	 	<form style="padding: 5%; " action="" method="post">
  	 	 		...
  	 	 		" style="font-size: 20px; " rows="4" cols="50" name="comment" placeholder="write your comment..." required="">
          </textarea>
  	 	 		<br><br>
  	  ...
  	  <div style="padding: 10px;" class="scroll">
              ...
              {
              	$sql="INSERT INTO `comments` (`id`,`user`, `comments`) VALUES (NULL,'$_SESSION[login_user]', '$_POST[comment]')";
