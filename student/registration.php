...
<?php
  ...
  {   
    $cnt=0;
    $qr="SELECT `username` from `student`";
    ...
    while($row=mysqli_fetch_assoc($res))
    {
     ...
     if($cnt==0)
     {
    $sql="INSERT INTO `student` (`first_name`, `last_name`, `username`, `password`, `email`, `contact`,`image`) VALUES ('$_POST[fname]', '$_POST[lname]','$_POST[uname]','$_POST[password]','$_POST[email]','$_POST[phone]','user.jpg')";
