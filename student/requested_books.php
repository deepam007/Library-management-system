...
function closeNav() {
  ...
  <div style="width: 1000px; text-align: center;margin-left: 300px; margin-top: 100px;">
   <?php
      ...
      {     
      	?>
      	<h2 style="font-size: 40px; padding-top: 5px; height: 60px; width: 800px; margin-left: 100px; background-color: black; color: white;">Your Requested Books..</h2>
      	<?php
             $sql1="SELECT * from `issue_book`,`books` where `issue_book`.`username`= '$_SESSION[login_user]' AND `books`.`bid`=`issue_book`.`bid` ";
