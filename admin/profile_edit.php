...
if($pic)
   {
        ...
        mysqli_query($db,"UPDATE admin SET image='$pic' where username='$username'");
        $_SESSION['img1']=$pic;
    }
//////////////////////////////////////////////////////////////////////////////////////////////////
  	if(($_POST['fname']))
  	{ 
  		mysqli_query($db,"UPDATE admin SET first_name='$fname' where username='$username'");
  	}
  	if(($_POST['lname']))
  	{
  		mysqli_query($db,"UPDATE admin SET last_name='$lname' where username='$username';");
  	}
  	if(($_POST['username']))
  	{
  		mysqli_query($db,"UPDATE admin SET username='$new_username' where username='$username';");
  	...
  	if(($_POST['email']))
  	{
  		mysqli_query($db,"UPDATE admin SET email='email' where username='$username';");
  	}
  	if(($_POST['contact']))
  	{
  		mysqli_query($db,"UPDATE admin SET contact='$contact' where username='$username';");
  	}
